...
namespace Probel.NDoctor.View.Toolbox.Converters
{
    ...
    public class GenderToImageConverter : IValueConverter
    {
        ...
        {
            var uri = @"\Probel.NDoctor.View.Toolbox;component/Images\{0}.png";
            ...
            {
                case Gender.Male:
                    result = new Uri(uri.FormatWith("Male"), UriKind.Relative);
                    break;
                case Gender.Female:
                    result = new Uri(uri.FormatWith("Female"), UriKind.Relative);
                    break;
                default:
