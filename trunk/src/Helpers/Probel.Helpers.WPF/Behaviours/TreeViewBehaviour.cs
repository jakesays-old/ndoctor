...
namespace Probel.Helpers.WPF.Behaviours
{
    ...
    public class TreeViewBehaviour
    {
        ...
        public static readonly DependencyProperty SelectedItemChangedProperty = 
            DependencyProperty.RegisterAttached("SelectedItemChanged", typeof(ICommand), typeof(TreeViewBehaviour), new UIPropertyMetadata(null, SelectedItemChanged));

        // Using a DependencyProperty as the backing store for SelectedItem.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty SelectedItemProperty = 
            DependencyProperty.RegisterAttached("SelectedItem", typeof(object), typeof(TreeViewBehaviour), new UIPropertyMetadata(null, SelectedItemChanged));
