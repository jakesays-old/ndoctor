...
*/
namespace Probel.NDoctor.PluginHost.Host.Exceptions
{
    using System;
    ...
    public class AppConfigurationException : Exception
    {
        ...
        public AppConfigurationException()
            : this(Messages.Ex_AppConfigurationException)
        {
        }

        public AppConfigurationException(string message)
            : base(string.Format(Messages.Ex_AppConfigurationException, message))
        {
        }
