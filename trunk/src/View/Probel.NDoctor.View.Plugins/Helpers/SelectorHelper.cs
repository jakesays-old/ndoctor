...
namespace Probel.NDoctor.View.Plugins.Helpers
{
    ...
    public class SelectorHelper
    {
        ...
        public static readonly DependencyProperty SelectionChangedProperty = DependencyProperty.RegisterAttached("SelectionChanged", typeof(ICommand), typeof(SelectorHelper), new UIPropertyMetadata(null, SelectionChanged));
        ...
        {
            target.SetValue(SelectorHelper.SelectionChangedProperty, command);
        }
        ...
        private class Behaviour
        {
            ...
            public Behaviour(Selector selector)
            {
                ...
                this.selector.SelectionChanged += (sender, e) =>
                {
                    ...
                    var command = (ICommand)element.GetValue(SelectorHelper.SelectionChangedProperty);
