    ...
    public static class Create
    {
        ...
        public static Doctor ADoctor(Address address, Tag specialisation, string lastName)
        {
            return new Doctor()
            {
                ...
                MailPro = Guid.NewGuid().ToString(),
                MobilePro = Guid.NewGuid().ToString(),
                PhonePro = Guid.NewGuid().ToString(),
        ...
        public static Patient APatientBillGates(Address address, Tag tag, Reputation reputation, Insurance insurance, Practice practice, Profession profession)
        {
            return new Patient()
            {
                FirstName = "Bill",
                LastName = "Gates",
                MailPro = "Some mail pro",
                MobilePro = "Some mobile pro",
                PhonePro = "Some phone pro",
                Address = address,
