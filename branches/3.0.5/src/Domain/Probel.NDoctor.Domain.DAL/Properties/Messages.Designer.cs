...
namespace Probel.NDoctor.Domain.DAL.Properties {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A user with the same first and last name already exist..
        /// </summary>
        internal static string Ex_ExistingItemException_UserWithSameName {
            get {
                return ResourceManager.GetString("Ex_ExistingItemException_UserWithSameName", resourceCulture);
            }
        }
